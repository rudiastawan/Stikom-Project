      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                  ...
                  <input type="hidden" name="id_books" value="<?php echo $buku->id_books ?>" class="form-control" placeholder="Enter Book Title">
    
            
              <div class="form-group">
                <label>Type</label>
                <select class="form-control select2" value ="<?php echo $buku->type ?>" style="width: 100%;" name="type">
               ...
               <div class="form-group">
                  <label>Title</label>
                  <input type="text" name="title" value="<?php echo $buku->title ?>" class="form-control" placeholder="Enter Book Title">
               </div>

               <div class="form-group">
                  <label>Author</label>
                  <input type="text" name="author" value="<?php echo $buku->author ?>" class="form-control" placeholder="Enter Author">
               </div>

               <div class="form-group">
                  <label>Publisher</label>
                  <input type="text" name="publisher" value="<?php echo $buku->publisher ?>" class="form-control" placeholder="Enter Publisher">
               </div>

               <div class="form-group">
                  <label>Date of Publish</label>
                  <input type="date" name="date_of_publish" value="<?php echo $buku->date_of_publish ?>" class="form-control" placeholder="Enter Book Title">
               </div>
            ...
            <div class="col-md-6">
               ...
               <div class="form-group">
                  <label>ASBN</label>
                  <input type="text" name="ASBN" value="<?php echo $buku->ASBN ?>" class="form-control" placeholder="Enter ASBN">
               </div>

               <div class="form-group">
                  <label>Price</label>
                  <input type="text" name="price" value="<?php echo $buku->price ?>" class="form-control" placeholder="Enter Price">
               </div>

               <div class="form-group">
                  <label>Amount</label>
                  <input type="text" name="amount" value="<?php echo $buku->amount ?>" class="form-control" placeholder="Enter Amount">
               </div>

               <div class="form-group">
                  <label>Edition</label>
                  <input type="text" name="edition" value="<?php echo $buku->edition ?>" class="form-control" placeholder="Enter Edition">
               </div>

               <div class="form-group">
                  <label>Description</label>
                  <input type="text" name="description" value="<?php echo $buku->description ?>" class="form-control" placeholder="Enter Description">
               </div>
        ...
        <div class="box-footer">
            <div class="col-lg-2" style="float: right; margin-right: -15px;">
               <button type="sumit" name="button_edit_books" class="btn btn-block btn-success btn-flat">Edit Book Data</button>
         </div>
