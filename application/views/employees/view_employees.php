...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <br />
      <div class="row">
         <div class="col-lg-2">
            <a href="<?php echo site_url('employees/add_employees') ?>"><button type="button" class="btn btn-block btn-primary btn-flat">Add Book Data</button></a>
         </div>
            ...
            <div class="box-body no-padding">
              <table class="table table-bordered">
                <tr style="background-color: #0099CC;">
                  ...
                  <th style="width: 350px; text-align: center; color: #ffffff;">NAME</th>
                  <th style="text-align: center; color: #ffffff;">ADDRESS</th>
                  <th style="text-align: center; color: #ffffff;">E-MAIL</th>
                </tr>

                <?php
                  $no = 1;
                  foreach ($employe as $e => $row) {
                     ?>
                     <tr>
                        <td align="center"><?= $no; ?></td>
                        <td align="center"><?= $row->name_employees ?></td>
                        <td align="center"><?= $row->address_employees ?></td>
                        <td align="center"><?= $row->email_employees ?></td>
                     </tr>
                     <?php
                      $no++;
                  }
